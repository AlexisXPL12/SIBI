<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card-body">
                <div class="page-title-box d-flex align-items-center justify-content-between p-0">
                    ...
                    <div class="page-title-right">
                        <a href="<?php echo BASE_URL; ?>nuevo-cliente-api" class="btn btn-primary waves-effect waves-light">+ Nuevo</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= BASE_URL ?>reporte-clientes-api" class="btn btn-success waves-effect waves-light">
