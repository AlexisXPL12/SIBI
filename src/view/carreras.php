        ...
        <div class="card">
            <div class="card-body">
                <div class="page-title-box d-flex align-items-center justify-content-between p-0">
                    <h4 class="mb-0 font-size-18">Carreras</h4>
                    <div class="page-title-right">
                        <a href="<?php echo BASE_URL; ?>nueva-carrera" class="btn btn-primary waves-effect waves-light">+ Nuevo</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row col-12">
                    <div class="form-group row mb-3 col-6">
                        <label for="busqueda_codigo_carrera" class="col-5 col-form-label">Código:</label>
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_codigo_carrera" id="busqueda_codigo_carrera" placeholder="Ej: CAR-001">
                        </div>
                    </div>
                    <div class="form-group row mb-3 col-6">
                        <label for="busqueda_nombre_carrera" class="col-5 col-form-label">Carrera:</label>
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_nombre_carrera" id="busqueda_nombre_carrera" placeholder="Ej: Computación e Informática">
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="filtros_tabla_header" class="form-group row page-title-box d-flex align-items-center justify-content-between m-0 mb-1 p-0">
                    ...
                    <input type="hidden" id="filtro_codigo_carrera" value="">
                    <input type="hidden" id="filtro_nombre_carrera" value="">
                    <div>
