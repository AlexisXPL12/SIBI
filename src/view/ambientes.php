        ...
        <div class="card">
            <div class="card-body">
                <div class="page-title-box d-flex align-items-center justify-content-between p-0">
                    <h4 class="mb-0 font-size-18">Dependencias</h4>
            ...
            <div class="card-body">
                ...
                <div class="row col-12">
                    <div class="form-group row mb-3 col-6">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_tabla_codigo" id="busqueda_tabla_codigo" placeholder="Ej: DEP-001">
                        </div>
                    </div>
                    <div class="form-group row mb-3 col-6">
                        <label for="busqueda_tabla_dependencia" class="col-5 col-form-label">Dependencia:</label>
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_tabla_dependencia" id="busqueda_tabla_dependencia" placeholder="Ej: Biblioteca">
                        </div>
                    </div>
                </div>
